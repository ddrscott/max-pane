...
| §5.2: "Fullscreen `NSWindow`" — built as fullscreen at every launch | The owner leaves it windowed beside another app and wants it back that way. Fullscreen on the first launch only; after that the window's last state, from the ledger | [ADR-0036](decisions/0036-the-window-comes-back-where-you-left-it.md) |
