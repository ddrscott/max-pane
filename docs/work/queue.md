...
- [ ] Dock a lane to the left or right, overlaying or insetting the strip — [detail](docked-panes.md) — model half building; view half blocked on motion round 2
- [ ] Browser chrome round 2: a failed navigation says nothing, ⌘L is dead, ⌘-click loses your place — [detail](chrome-round-2.md) — blocked on motion round 2
